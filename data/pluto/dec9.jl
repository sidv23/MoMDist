...
type_list = ["Unweighted", "KDist", "MoMKDist", "DTM", "MOMDist", "all"];
...
t = $(@bind t PlutoUI.Slider(range( 1e-2, 3.5, length=1000); default=0.01, show_value=true))
...
begin
	...
	# Kernel Stuff
	k = (1.5) * RationalQuadraticKernel() ∘ ScaleTransform(1 / σ)
...
# ╔═╡ 1cef9f7a-472c-4c11-a529-0a80df0ef72e
gr()
